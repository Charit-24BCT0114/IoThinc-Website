              ...
              {quickLinks.map((link) => (
                <li key={link.tab}>
                  <button
                    ...
                    className="text-gray-400 hover:text-cyan-400 transition-colors bg-transparent border-none cursor-pointer p-0"
                  >
                    {link.label}
                  </button>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {['Tech Blog', 'Research Papers', 'Tutorials', 'Documentation', 'Community'].map((r) => (
                <li key={r}>
                  <a href="#" className="text-gray-400 hover:text-cyan-400 transition-colors">{r}</a>
                </li>
              ))}
            </ul>
          </div>
